    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-gray-200/60 px-4 xl:px-5 2xl:px-6 py-3 xl:py-4 2xl:py-5 flex-shrink-0 bg-white/90 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
          <h3 className="text-base sm:text-lg xl:text-xl 2xl:text-2xl font-bold text-gray-900 tracking-tight">Incident Details</h3>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 xl:p-6 2xl:p-7 space-y-4 xl:space-y-5 2xl:space-y-6 text-gray-900">
          {/* Agent & Host Info */}
          <div>
            <p className="font-bold text-xs xl:text-sm 2xl:text-base text-gray-500 uppercase tracking-wider mb-0.5">Affected Agent</p>
            <p className="text-sm sm:text-base xl:text-lg 2xl:text-xl font-bold text-[#002B9A]">{incident.agent}</p>
            {incident.host && incident.host !== incident.agent && (
              <p className="text-xs xl:text-sm 2xl:text-base font-medium text-gray-500 mt-0.5">Hostname: {incident.host}</p>
            )}
          </div>
          ...
          >
            ...
            <div className="bg-[#002B9A]/95 backdrop-blur-md text-white px-5 py-3.5 flex items-center justify-between flex-shrink-0 border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold tracking-tight">Security Event Full Log (Wazuh SIEM)</h3>
              </div>
              <button
                onClick={() => setIsRawLogOpen(false)}
                className="text-white hover:text-gray-300 font-bold p-1 rounded-md transition cursor-pointer"
            ...
            <div className="bg-slate-100/70 backdrop-blur-md border-b border-gray-200/60 px-5 py-2.5 flex flex-wrap items-center justify-between gap-2 flex-shrink-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
              ...
              <div className="relative flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  className="w-full bg-white/80 text-xs font-medium text-gray-900 pl-8 pr-2.5 py-1.5 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#002B9A]"
                />
              </div>

              {/* View mode toggle & Actions */}
              <div className="flex items-center gap-2">
                <div className="bg-white/80 p-0.5 rounded-md border border-gray-300 flex text-xs font-bold">
                  <button
                ...
                <button
                  ...
                  className="bg-white/90 hover:bg-white text-gray-800 text-xs font-bold px-2.5 py-1.5 rounded-md border border-gray-300 flex items-center gap-1 transition shadow-sm cursor-pointer"
                >
