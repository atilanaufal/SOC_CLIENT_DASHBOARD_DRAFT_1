...
>>>>>>> Stashed changes
          <div>
            <h3 className="text-lg 2xl:text-xl font-black text-gray-900 tracking-tight">Device Details</h3>
          </div>
          <button
            onClick={onClose}
