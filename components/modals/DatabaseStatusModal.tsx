...
export const DatabaseStatusModal: React.FC<DatabaseStatusModalProps> = ({ isOpen, onClose }) => {
  ...
  const renderReconciliationTable = (p: any) => {
    ...
    return (
      <div className="space-y-3">
        <div className="overflow-x-auto bg-white/80 rounded-lg border border-gray-200">
  ...
  return createPortal(
    <div
      onClick={onClose}
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/25 animate-in fade-in duration-150 cursor-pointer"
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="bg-white/85 backdrop-blur-2xl border border-white/80 rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col text-gray-900 overflow-hidden cursor-default shadow-[0_20px_50px_rgba(0,43,154,0.12),inset_0_1px_2px_rgba(255,255,255,0.95)]"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#002B9A]/95 backdrop-blur-md text-white rounded-t-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {loading ? (
                  <span className="px-2.5 py-0.5 text-xs font-bold bg-[#002175] text-blue-200 rounded-full animate-pulse border border-[#001955]">
                    Checking...
                  </span>
                ) : allSynced ? (
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={fetchStatus}
              disabled={loading}
              className="p-2 text-gray-300 hover:text-white bg-black/30 hover:bg-black/50 rounded-lg transition border border-white/20 disabled:opacity-50"
            ...
            <button
              onClick={onClose}
              className="p-2 text-gray-300 hover:text-white bg-black/30 hover:bg-black/50 rounded-lg transition border border-white/20"
            >
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-1 px-6 pt-3 bg-slate-100/70 backdrop-blur-md border-b border-gray-200/60 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
          <button
            onClick={() => setActiveTab('overview')}
            className={`px-4 py-2 text-xs font-extrabold rounded-t-lg transition flex items-center gap-2 border-b-2 ${
              activeTab === 'overview'
                ? 'bg-white/80 backdrop-blur-sm text-[#002B9A] border-[#002B9A] shadow-[0_-2px_6px_rgba(0,43,154,0.05)]'
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-transparent">
          ...
          {activeTab === 'overview' && (() => {
            ...
            return (
              <div className="space-y-6">
                ...
                <div className="p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200 space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <span className={`px-3 py-1 border rounded-full text-xs font-black flex items-center gap-1.5 ${activeBadgeStyle}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* MongoDB Card */}
                <div className="p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200 transition space-y-3">
          ...
          {activeTab === 'sync' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-gray-200">
                <div>
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-extrabold bg-[#002B9A] hover:bg-[#002175] text-white rounded-lg transition flex items-center gap-2 disabled:opacity-50 border border-[#002175]"
                >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-gray-200">
                ...
                <button
                  ...
                  disabled={actionLoading}
                  className="px-4 py-2 text-xs font-extrabold bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition flex items-center gap-2 disabled:opacity-50 border border-amber-700"
                >
        ...
        {/* Modal Footer */}
        <div className="px-6 py-3.5 border-t border-gray-300 bg-slate-200/80 flex items-center justify-between text-xs text-gray-700 font-medium rounded-b-2xl">
          <span>Target VM: <code className="text-gray-900 font-bold">192.168.1.20</code> | Wazuh Pipeline SOC</span>
          <button
            onClick={onClose}
            className="px-4 py-1.5 bg-[#002B9A] hover:bg-[#002175] text-white font-extrabold rounded-lg transition border border-[#002175]"
          >
            Tutup Modal
          </button>
        </div>
