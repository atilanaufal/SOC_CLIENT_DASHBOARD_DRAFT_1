      ...
      >
        ...
        <div className="bg-[#002B9A]/95 backdrop-blur-md text-white px-6 py-4 flex items-center justify-between flex-shrink-0 border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold tracking-tight">{report.reportName}</h3>
              <p className="text-xs text-blue-200 font-medium">SOC ID: {socIdDisplay} | UUID: {uuidDisplay.substring(0, 18)}...</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Info Toolbar */}
        <div className="bg-slate-100/70 backdrop-blur-md border-b border-gray-200/60 px-6 py-2.5 flex items-center justify-between text-xs font-semibold text-gray-700 flex-shrink-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
          <div className="flex items-center gap-4">
            <div>
              <span className="text-gray-500 font-medium mr-1">Severity:</span>
              <span
                className={`inline-block px-2.5 py-0.5 rounded-md text-xs sm:text-sm font-bold ${
            ...
            <div>
              <span className="text-gray-500 font-medium mr-1">Generated:</span>
          ...
          {recommendedActionText && (
            <section className="bg-white/80 backdrop-blur-xl p-5 rounded-xl border border-white/80 shadow-[0_8px_32px_0_rgba(31,38,135,0.04),inset_0_1px_1px_0_rgba(255,255,255,0.9)]">
              <div className="mb-3 pb-2 border-b border-emerald-200">
                <h4 className="text-sm font-bold text-emerald-900 uppercase tracking-wider">Recommended Action</h4>
              </div>
