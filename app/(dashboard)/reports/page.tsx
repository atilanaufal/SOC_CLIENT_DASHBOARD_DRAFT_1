    ...
    <div className="w-full flex-1 flex flex-col lg:flex-row gap-3 min-w-0 items-stretch">
      ...
      <div className={`flex-1 flex flex-col gap-3 min-w-0 w-full ${isDrawerOpen ? "lg:mr-[402px] xl:mr-[442px] 2xl:mr-[492px]" : ""}`}>
        ...
        <div className="max-w-md bg-white/70 backdrop-blur-xl p-3 sm:p-3.5 2xl:p-4 rounded-xl border border-white/70 shadow-[0_8px_32px_0_rgba(31,38,135,0.04),inset_0_1px_1px_0_rgba(255,255,255,0.9)] flex items-center gap-3 sm:gap-3.5 2xl:gap-4 flex-shrink-0">
          <div className="w-10 h-10 sm:w-12 sm:h-12 2xl:w-14 2xl:h-14 rounded-xl bg-[#002B9A]/95 backdrop-blur-sm text-white flex items-center justify-center font-bold text-xs border border-white/20 shadow-[0_4px_12px_rgba(0,43,154,0.3)]">
            <HiOutlineDocumentText className="w-5 h-5 sm:w-6 sm:h-6 2xl:w-7 2xl:h-7 text-blue-300" />
          </div>
          <div>
            <h4 className="font-bold text-xs sm:text-sm 2xl:text-base text-gray-900">Total Reports</h4>
            <p className="text-xl sm:text-2xl 2xl:text-3xl font-bold text-[#002B9A]">
              {filteredReports.length} <span className="text-[11px] sm:text-xs 2xl:text-sm font-semibold text-gray-500 uppercase tracking-wider">Available</span>
            </p>
          </div>
        </div>
          ...
          <div className="overflow-x-auto overflow-y-auto flex-1">
            <table className="w-full text-left border-collapse min-w-[700px]">
              ...
              <tbody className="divide-y divide-gray-200 text-xs sm:text-xs md:text-xs xl:text-sm 2xl:text-base font-normal">
                {isLoading ? (
                  <tr>
                    <td colSpan={3} className="py-8 text-center font-semibold text-gray-500">
                      Loading reports...
                    </td>
                  </tr>
                ) : error ? (
                  <tr>
                    <td colSpan={3} className="py-8 text-center font-semibold text-red-600">
                      Error: {error}
                    </td>
                  </tr>
                  ...
                  paginatedReports.map((report) => {
                    ...
                    return (
                      ...
                      >
                        <td className="relative py-2 sm:py-2.5 xl:py-3 2xl:py-3.5 px-2.5 sm:px-3.5 xl:px-4 2xl:px-5 text-[#002B9A] font-semibold">
