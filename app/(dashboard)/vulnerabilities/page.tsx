    ...
    <div className="w-full flex flex-col lg:flex-row gap-3 min-w-0">
      ...
      <div className="flex-1 flex flex-col gap-3 min-w-0 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 flex-shrink-0">
          {/* Total Vulnerability */}
          <div className="md:col-span-5 bg-white/70 backdrop-blur-xl p-3.5 rounded-xl border border-white/70 shadow-[0_8px_32px_0_rgba(31,38,135,0.04),inset_0_1px_1px_0_rgba(255,255,255,0.9)] flex items-center justify-around gap-3">
            <BestDonutChart
            ...
            <div className="space-y-1 text-xs font-bold">
              <h4 className="text-xs font-black uppercase text-gray-500 tracking-wider border-b border-gray-200/50 pb-0.5">
                Total Vulnerability
              </h4>
          ...
          <div className="md:col-span-4 bg-white/70 backdrop-blur-xl p-3.5 rounded-xl border border-white/70 shadow-[0_8px_32px_0_rgba(31,38,135,0.04),inset_0_1px_1px_0_rgba(255,255,255,0.9)] flex items-center gap-3">
            <BestDonutChart
            ...
            <div className="flex-1 text-xs">
              <h4 className="font-black text-xs uppercase tracking-wider text-gray-500 mb-1.5 border-b border-gray-200/50 pb-0.5">
                Vuln Distribution
              </h4>
          ...
          {/* Solved Vuln */}
          <div className="md:col-span-3 bg-white/70 backdrop-blur-xl p-3.5 rounded-xl border border-white/70 shadow-[0_8px_32px_0_rgba(31,38,135,0.04),inset_0_1px_1px_0_rgba(255,255,255,0.9)] flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-emerald-50/90 backdrop-blur-sm border border-emerald-300 flex-shrink-0 flex items-center justify-center text-emerald-600 shadow-[inset_0_1px_1px_rgba(255,255,255,0.9)]">
              <HiOutlineCheckCircle className="w-7 h-7" />
            </div>
            <div>
              <h4 className="font-extrabold text-xs uppercase tracking-wider text-gray-500">Solved Vuln</h4>
              <div className="flex items-baseline gap-2 mt-0.5">
                <span className="text-3xl font-black text-emerald-700">{stats.solved}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse table-fixed">
              <thead>
                <tr className="bg-[#002B9A]/95 backdrop-blur-md text-white text-xs font-black tracking-wider sticky top-0 z-10 select-none border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
                  <th onClick={() => handleSort('name')} className="w-[30%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Vulnerability</span>
                      {renderSortIndicator('name')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('severity')} className="w-[12%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Severity</span>
                  ...
                  <th onClick={() => handleSort('agent')} className="w-[15%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Agent</span>
                      {renderSortIndicator('agent')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('cveId')} className="w-[15%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>CVE ID</span>
                      {renderSortIndicator('cveId')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('detectionDate')} className="w-[16%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      ...
                      >
                        <td className="py-2 px-3.5 text-gray-900 font-extrabold">
                          <div className="flex items-center gap-2">
                            <HiOutlineShieldExclamation className="w-4 h-4 text-[#002B9A] flex-shrink-0" />
                        ...
                        <td className="py-2 px-3.5 font-bold">
                          <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-extrabold ${
                            ...
                            {vuln.status === 'Solved' || vuln.status === 'Patched' ? <HiOutlineCheckCircle className="w-3.5 h-3.5" /> : <HiOutlineXCircle className="w-3.5 h-3.5" />}
                            {vuln.status}
                          </span>
                        </td>

                        <td className="py-2 px-3.5 text-[#0066B1] font-bold">{vuln.agent}</td>
                        <td className="py-2 px-3.5 text-[#002B9A] font-extrabold">{vuln.cveId}</td>
