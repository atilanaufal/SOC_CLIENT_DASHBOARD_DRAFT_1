  ...
  return (
    <div className="w-full flex flex-col lg:flex-row gap-3 min-w-0">
      ...
      <div className="flex-1 flex flex-col gap-3 min-w-0 w-full">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-xl border border-white/70 p-4 flex-shrink-0">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-gray-200/60">
            {/* Critical Column */}
            <div className="md:pr-4">
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="bg-[#FF1E1E] text-white text-xs font-black px-2.5 py-0.5 rounded-md shadow-[0_2px_6px_rgba(255,30,30,0.3)]">
                    Critical
                  </span>
            ...
            <div className="md:px-4 pt-2 md:pt-0">
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="bg-[#FF6B00] text-white text-xs font-black px-2.5 py-0.5 rounded-md shadow-[0_2px_6px_rgba(255,107,0,0.3)]">
                    High
                  </span>
            ...
            <div className="md:pl-4 pt-2 md:pt-0">
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="bg-[#FFC700] text-white text-xs font-black px-2.5 py-0.5 rounded-md shadow-[0_2px_6px_rgba(255,199,0,0.3)]">
                    Medium
                  </span>
            ...
            <table className="w-full text-left border-collapse table-fixed">
              <thead>
                <tr className="bg-[#002B9A]/95 backdrop-blur-md text-white text-xs font-black tracking-wider sticky top-0 z-10 select-none border-b border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
                  <th onClick={() => handleSort('incidentName')} className="w-[45%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Incident</span>
                      {renderSortIndicator('incidentName')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('severity')} className="w-[15%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Severity</span>
                      {renderSortIndicator('severity')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('agent')} className="w-[20%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                      <span>Agent</span>
                      {renderSortIndicator('agent')}
                    </div>
                  </th>
                  <th onClick={() => handleSort('firstObserved')} className="w-[20%] py-2.5 px-3.5 cursor-pointer hover:bg-[#002175] transition">
                    <div className="flex items-center">
                  ...
                  paginatedIncidents.map((inc) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2 px-3.5 text-[#0066B1] font-extrabold">{inc.agent}</td>
